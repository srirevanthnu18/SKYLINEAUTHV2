...
def handle_api():
    try:
        ...
        # HWID Length Check (Official feature)
        min_hwid_len = app.get('minHwid', 0)
        if hwid and len(hwid) < min_hwid_len:
            resp = {"success": False, "message": f"HWID must be {min_hwid_len} or more characters, change this in app settings."}
